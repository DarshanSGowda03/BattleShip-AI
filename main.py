...
while animating:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not game.over:
            ...
            if not game.player1_turn and x < SQ_SIZE * 10 and y < SQ_SIZE * 10:
                row = y // SQ_SIZE
                col = x // SQ_SIZE
                index = row * 10 + col
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # Space bar to pause and unspace the animation
    ...
    if not pausing:
        ...
        # draw ships onto postiton grids
